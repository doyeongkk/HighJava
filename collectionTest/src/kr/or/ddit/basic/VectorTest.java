...
//      System.out.println("v1:"+v1.toString());
     ...
     /*
         제네릭 타입(Generic Type)==> 객체를 선언할 때 < > 괄호 안에 그 Collection이
                			     ...
                			     그래서, int는 Integer, boolean은 Bollean, char은 Character등으로 대체해서 사용해야 한다.
         제네릭 타입으로 선언하게 되ㅐ면 데이터를 꺼내올 대 형변환이 필요 없다.            			  
      */
     Vector<String> v2 =new Vector<String>(); // String만 저장할 수 있는 Vector 객체 선언
     Vector<Integer> v3 = new Vector<>();     // int형 데이터만 저장할 Vector 객체 선언
     ...
     v2.removeAll(v4);
     System.out.println("삭제 후v2:" + v2);
     System.out.println("삭제 후v4:" + v4);
     System.out.println("-------------------------------------------");
     ...
     // 백터의 데이터를 순서대로 가져와 모두사용하고 싶으면 반복문을 사용하면 된다. 
     // (주로 for문을 사용한다.)
