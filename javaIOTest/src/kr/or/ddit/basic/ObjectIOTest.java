...
public class ObjectIOTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// readObject()메서드가 데이터의 끝까지 다 읽어오면 EOFExcption을 발생한다. 
...
class Member implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6895092178625435601L;
	
	private String name;
	private transient int age;
	private transient String addr;
	
	//transient ==> 직렬화가 되지 않을 변수에 저장한다.
	//          ==> 직렬화가 되지 않은 멤버변수는 기본값으로 저장된다.
	//          ==> 기본값(참조형변수: null,숫자형 변수: 0, 논리형 변수: false)
