...
public class EnumTest {
	...
	public enum Season{
		...
		// 생성자
		Season(int sMonth, String eMonth){   //private Season(int sMonth, String eMonth)
			startMonth = sMonth;
			endMonth = eMonth;
		}
		//getter메서드 작성
	...
	public static void main(String[] args) {
		 ...
		 * ConstTest.THREE);
		 * 
		 * if(ConstTest.RED==ConstTest.TWO) { System.out.println("~~~~~~~~~~~~"); }else
		 * { System.out.println("@@@@@@"); }
		 */

		Color mycol = Color.valueOf("GREEN"); // 방법 1
		Color mycol2 = Color.GREEN; // 방법 2
